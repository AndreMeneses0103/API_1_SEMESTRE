...
def abrir_dash_ge():
    ...
    class tela_dashboard_gerencial:
        ...
        #botaoFeedback = ctk.CTkButton(master=janelaDashGerencial, text= "Feedbacks Recebidos", text_color=('black'), cursor='hand2', fg_color='#00FFFF', hover_color='#2FCDCD', command=open_feedback).place(x=1030, y =400)
        botaoMenuInicial = ctk.CTkButton(master=janelaDashGerencial, text= "Menu Inicial", text_color=('black'), cursor='hand2', fg_color='#00FFFF', hover_color='#2FCDCD').place(x=1030, y =350)
