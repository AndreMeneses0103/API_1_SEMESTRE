...
class Avaliação:
    ...
    def tela_avaliação(self):
        ...
        avaliado = 'Jhony Santos de Souza'
        ...
        def questionario():
            ...
            for linha in range(len(perguntas)):
                ...
                print(perguntas[linha])
            pass
        questionario()

        button_proximo = ctk.CTkButton(perguntas_frame, text='Próximo', font=('Roboto', 20, 'bold'), fg_color='#5CE1E6', text_color='black', cursor="hand2", width=230 ).place(x=600, y=550)
        pass
